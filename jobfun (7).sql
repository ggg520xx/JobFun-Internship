...
(21, 'axz122', '1234', 'NAS Inc.', 1, '台北市中正區大埔街36號', '06-3154778', 'nvos@gnmail.com', 'pending', '1606979016537-add_job_0.png', '1606979054527-add_job_0.png', '1606979057883-add_job_1.png', '1606979062123-add_job_2.png', '1606979065490-add_job_3.png', '1606979068389-add_job_4.png', '專注於企業IT軟硬體設備代理業務將近四十年，\n多年來零壹以專業的能力、熱情的態度、服務的精神，結合專業與服務，\n並力行實踐，與合作夥伴達到雙贏的目標；\n創造與客戶共生互利的價值，讓原廠、經銷夥伴，以及終端客戶，\n都能透過零壹提供的解決方案獲得最大價值與商機。');
...
(48, '實習前端工程師', 21, 1, 1, '台北市中正區大埔街36號', '2020-12-03 15:05:12', '2021-01-01', '2021-02-28', '【工作內容】\n• 資訊相關科系 大三大四生或剛畢業者尤佳\n• 熟悉javascript, Git版控尤佳\n', '●實習福利制度：\n1.訓練計畫：我們不只提供實習，更給予專業培訓，若無快速學習能力、學習熱誠者，請審慎申請\n2.獎助學金：工作態度及格者，將提供獎助學金五千元，非台中人另提供住宿或交通津貼(最高五千)，表現優秀者可申請留任獎助學金兩萬元。', '【相關條件】\n- 科系要求：資訊工程相關\n- 語文條件：不拘\n- 擅長工具：JavaScript、jQuery、CSS、Node.js、D3.js\n- 工作技能：資料庫程式設計', 'on');
...
(15, 1, 48, 34, '123', 'notviewed', NULL, '2020-12-03'),
(16, 1, 45, 34, '55', 'notviewed', NULL, '2020-12-03'),
(17, 21, 38, 41, '', 'notviewed', NULL, '2020-12-04'),
(18, 24, 38, 46, 'w', 'notviewed', NULL, '2020-12-04');
...
(1, 'leo20xx', '123', 'ReyHong', '男', '1994-10-13', 'leo266470@gmail.co', '091052814', '2020-11-07', 'approved', 1, 1, '資訊工程學系', '', NULL, '1606979512155-add_job_4.png'),
...
(23, 'SAS456', '1', 'JasonChen', '男', '1995-10-13', 'json1@gxmail.com', '0912789547', '2020-12-02', 'pending', 1, 1, '資訊工程學系', '1606875117481-front.png', '1606875117484-back.png', '1606875145004-avatar.jpg'),
(24, 'qqq123', '123', 'JasonChen', '男', '1995-10-13', 'json1@gxmail.com', '0912789547', '2020-12-04', 'pending', 1, 1, '資訊工程學系', '1607067254749-front.png', '1607067254753-back.png', NULL);
...
(46, 24, 'sss', 'json1@gxmail.com', '0912789547', 'w', '1607067306909-1606409421638-洪瑞陽_履歷.pdf');
...
--
ALTER TABLE `collectlist`
  MODIFY `collcetId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `jobapply`
  MODIFY `jobAppyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `resume`
  MODIFY `resumeId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
